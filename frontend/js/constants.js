...
export const NETWORK = {
    ...
    AUTH_DEBOUNCE_DELAY: 2000,          // 认证错误去抖延迟(毫秒)
 ...
 */
export const MEDIA = {
    HLS_MANIFEST_PATTERN: /\.m3u8$/i,    // HLS清单文件模式
    HLS_SEGMENT_PATTERN: /\.ts$/i,      // HLS分片文件模式
    VIDEO_CONTENT_TYPE_PATTERN: /^video\//i, // 视频内容类型模式
...
export const ENVIRONMENT = {
    ...
    PRODUCTION_HOST_PATTERN: /\.(local)$/,          // 生产环境主机模式
};
...
export const SETTINGS = {
    ...
    AI_LOCAL_KEY: 'ai_settings', // AI设置的本地存储键名
...
export const INDEXEDDB = {
    ...
    IDLE_CALLBACK_TIMEOUT: 2000, // requestIdleCallback超时(毫秒)
